...
switch (Grade) {
    case 'Grade 1':
        if (per >= 60 && fees == 25000) {
            console.log("Admission successful! Name:  " + name + "  percentage: " + per)
    ...
    case 'Grade 3':
        let sci = parseInt(prompt('Enter your sci: '));
        let per1 = (eng + dzo + math + sci) / 4;
        if (per1 >= 50 && fees == 45000) {
            console.log("Admission successful! Name:  " + name + "  percentage: " + per1)
